...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void move(){ //Function to move
    ...
    public void checkApple() { // Function to check with the apple(it has been eaten or not)
    ...
    public void checkCollisions() { // Function to check the collisions bw the snake and its body
    ...
    public void gameOver(Graphics g) { // Function to display the gameOver sign (also uses Graphics object g) 
